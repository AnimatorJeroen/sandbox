...
void InitImGuiStyles()
{
	...
	ImGui::GetIO().Fonts->AddFontFromFileTTF("resources/fonts/Mulish/static/Mulish-Regular.ttf", 16.0f);
	...
	colors[ImGuiCol_ButtonHovered] = ImVec4(0.13f, 0.32f, 0.84f, 1.00f);
	...
	colors[ImGuiCol_TabActive] = ImVec4(0.08f, 0.25f, 0.53f, 1.00f);
