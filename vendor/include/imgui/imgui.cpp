...
/*
 ...
 Q: How can I display custom bone_shapesSummary? (using low-level ImDrawList API)
 >> See https://www.dearimgui.org/faq
...
ImGuiStyle::ImGuiStyle()
{
    ...
    AntiAliasedFill         = true;             // Enable anti-aliasing on filled bone_shapesSummary (rounded rectangles, circles, etc.)
